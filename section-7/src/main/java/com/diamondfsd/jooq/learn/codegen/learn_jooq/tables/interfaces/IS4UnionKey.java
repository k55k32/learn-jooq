...
public interface IS4UnionKey extends Serializable {
     ...
     */
    public void from(com.diamondfsd.jooq.learn.codegen.learn_jooq.tables.interfaces.IS4UnionKey from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IS4UnionKey
     */
    public <E extends com.diamondfsd.jooq.learn.codegen.learn_jooq.tables.interfaces.IS4UnionKey> E into(E into);
}
