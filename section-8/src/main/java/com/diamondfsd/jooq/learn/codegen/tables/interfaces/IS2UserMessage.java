...
public interface IS2UserMessage extends Serializable {
     ...
     */
    public void from(com.diamondfsd.jooq.learn.codegen.tables.interfaces.IS2UserMessage from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IS2UserMessage
     */
    public <E extends com.diamondfsd.jooq.learn.codegen.tables.interfaces.IS2UserMessage> E into(E into);
}
