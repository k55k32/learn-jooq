...
public class S4NoPrimaryRecord extends TableRecordImpl<S4NoPrimaryRecord> implements Record4<String, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1304519394;
