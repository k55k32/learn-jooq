...
public interface IS4NoPrimary extends Serializable {
     ...
     */
    public void from(com.diamondfsd.jooq.learn.jooq.tables.interfaces.IS4NoPrimary from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IS4NoPrimary
     */
    public <E extends com.diamondfsd.jooq.learn.jooq.tables.interfaces.IS4NoPrimary> E into(E into);
}
