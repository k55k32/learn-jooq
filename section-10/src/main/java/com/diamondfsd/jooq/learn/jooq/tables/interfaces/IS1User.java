...
public interface IS1User extends Serializable {
     ...
     */
    public void from(com.diamondfsd.jooq.learn.jooq.tables.interfaces.IS1User from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IS1User
     */
    public <E extends com.diamondfsd.jooq.learn.jooq.tables.interfaces.IS1User> E into(E into);
}
