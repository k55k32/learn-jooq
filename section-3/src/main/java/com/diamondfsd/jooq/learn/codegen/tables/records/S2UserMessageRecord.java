...
public class S2UserMessageRecord extends UpdatableRecordImpl<S2UserMessageRecord> implements Record6<Integer, Integer, String, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = 606302728;
